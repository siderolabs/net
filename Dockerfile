...
#
# Generated on 2022-10-31T18:27:39Z by kres 03328da.
...
RUN FILES="$(goimports -l -local github.com/siderolabs/net .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'goimports -w -local github.com/siderolabs/net .':\n${FILES}"; exit 1)
